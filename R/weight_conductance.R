...
#' @param w A raster layer with values to be multiplied by \code{rose}. For example, supplying a layer with 1 for land and 0.1 for water would downweight connectivity over water by 90%. This layer must have the same spatial properties as the windrose raster.
