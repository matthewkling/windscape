...
The example code below shows a workflow that models and visualizes upwind and downwind accessibility site in North America, based on wind data for a few days in the year 2000. A more detailed set of vignettes is in development.
